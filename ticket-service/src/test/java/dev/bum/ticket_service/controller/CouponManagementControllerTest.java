...
@WebMvcTest(CouponManagementController.class)
class CouponManagementControllerTest {
    ...
    private final String baseUrl = "/api/v1/manage/coupon";

    @Test
    @DisplayName("인증 없이 관리자용 쿠폰 조회를 요청하면 4xx 응답")
