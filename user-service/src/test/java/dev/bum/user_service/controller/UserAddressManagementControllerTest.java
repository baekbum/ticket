...
import dev.bum.user_service.controller.address.UserAddressManagementController;
...
@WebMvcTest(UserAddressManagementController.class)
class UserAddressManagementControllerTest {
    ...
    private final String baseUrl = "/api/v1/manage/address";

    @Test
    @DisplayName("인증 없이 관리자용 주소 조회를 요청하면 4xx 응답")
