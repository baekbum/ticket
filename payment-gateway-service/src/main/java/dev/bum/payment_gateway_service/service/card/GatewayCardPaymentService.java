...
public class GatewayCardPaymentService {
    ...
    private void validateRefundableHistory(
        ...
        if (paymentHistory.getAmount().compareTo(request.getRefundAmount()) != 0) {
            throw new IllegalArgumentException("전체 환불 금액은 승인 금액과 일치해야 합니다.");
        }
    }
