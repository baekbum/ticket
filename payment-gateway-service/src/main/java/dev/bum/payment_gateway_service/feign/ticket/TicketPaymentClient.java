...
public interface TicketPaymentClient {
    ...
    @PostMapping("/api/v1/payments/internal/card/validate")
    PaymentResponse validateCardPayment(@RequestBody CardPaymentValidationRequest request);

    @PostMapping("/api/v1/payments/internal/card/settle")
    CardPaymentSettlementResponse settleCardPayment(@RequestBody CardPaymentCompleteRequest request);
